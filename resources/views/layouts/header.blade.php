...
<link rel="stylesheet" href="{{ asset('js/helpers/v6.1.1-dist/ol.css')   }}" type="text/css">
                     <script src="{{ asset('js/helpers/v6.1.1-dist/ol.js')  }}"></script>
                     <script src="{{ asset('js/geopoint.js')  }}"></script>
                    ...
                    <li class="nav-item dropdown login">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink"
                           ...
                           aria-haspopup="true" aria-expanded="false">
                            <span class="icon-claveunica"></span> Bienvenido/a, {{ Auth::user()->nombres }} ({{ Auth::user()->str_grupo_usuarios() }})
                        </a>
