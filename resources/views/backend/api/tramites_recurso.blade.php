...
@section('title', 'Trámites: recurso')
    ...
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="col-9">
                ...
                <p>Tramites es un listado de tramites de SIMPLE. Los métodos permiten obtener información de un trámite,
                    listar una serie de trámites o listar trámites que son parte de un proceso en particular.</p>

                <h3>Métodos</h3>

                <dl>
                    <dt><a href="{{route('backend.api.tramites_obtener')}}">obtener</a></dt>
                    <dd>Obtiene un recurso trámite.</dd>
                    <dt><a href="{{route('backend.api.tramites_listar')}}">listar</a></dt>
                    <dd>Obtiene el listado completo de trámites de la cuenta.</dd>
                    <dt>
                        <a href="{{route('backend.api.tramites_listarporproceso')}}">listarPorProceso</a>
                    </dt>
