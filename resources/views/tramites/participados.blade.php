<div class="row">
    <div class="col-xs-12 col-md-12">
        <h1 class="title">Solicitudes en que ha participado</h1>
        <hr>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-md-12">
	    ...
	    <?php $reg_proy = \App\Helpers\Doctrine::getTable('Etapa')->getRegion($t->id); ?>
            <?php $grp_array = array_map('strtoupper', Auth::user()->arr_grupos_usuario()); ?>

            <?php if ( in_array( strtoupper($reg_proy), $grp_array ) ): ?>
