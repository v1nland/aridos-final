...
(function($) {
	...
	Calendar.prototype.getNumberMonth = function() {
		var p = this.options.position.start;
		return p.getMonth()+1;
	};
	Calendar.prototype.getDateSelect = function() {
		var p = this.options.position.start;
		var m=(p.getMonth()+1);
		if(m<=9){
			m='0'+m;
		}
		return p.getDate()+'/'+m+'/'+ p.getFullYear();
	};
	...
	Calendar.prototype.reload_day = function() {
		var self = this;
		self.view('day');
	};
	...
	Calendar.prototype.getEventos = function() {
